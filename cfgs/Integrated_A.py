...
__C.num_ad = 3  # 广告数量
__C.num_org = 2  # organic数量

__C.num_bid =__C.num_ad + __C.num_org # ad & org的bid数量
__C.num_vol =__C.num_ad + __C.num_org  # ad & org的vol数量

__C.num_agent = __C.num_bid + __C.num_vol  # __C.num_agents等于__C.num_i加__C.num_j
__C.num_item = 3

__C.CTR = np.array([0.5,0.3,0.2])  # 长度或维度等于物品数量
...
__C.train.yuzhi_1 = 0.001



__C.train.yuzhi = 0.0009
