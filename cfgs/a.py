...
# __C.num_items = 2
__C.num_agents = 7  # __C.num_agents等于__C.num_i加__C.num_j
__C.num_items = 1

# __C.CTR=np.array([0.6,0.35,0.05])  #长度或维度等于物品数量

__C.CTR = np.array([0.7])  # 长度或维度等于物品数量

# __C.linjie0 =np.array([[1, 0, 2, 3],
#                        [0, 4, 0, 5]])  # 输入邻接矩阵
...
# __C.train.yuzhi = 0.00096
# __C.train.yuzhi = 0.00097
# __C.train.yuzhi = 0.00098
# __C.train.yuzhi = 0.00099
